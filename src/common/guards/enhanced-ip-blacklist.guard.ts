...
/**
 * Enhanced IP Blacklist Guard
 * 개선된 보안 정보 처리
 */
@Injectable()
export class EnhancedIpBlacklistGuard extends BaseSecurityGuard {
  protected override readonly logger = new Logger(EnhancedIpBlacklistGuard.name);
  ...
  protected getGuardName(): string {
    return 'EnhancedIpBlacklistGuard';
  }
